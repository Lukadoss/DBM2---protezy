...
class EdgeDetector{
    private static final double ORI_SCALE = 40;
    private static final double MAG_SCALE = 20;
    ...
    private void canny(float f, int gkernel) {
        ...
        int[] derivative_mag = new int[picsize];
    ...
    private void thresholding(int i, int j) {
        if (i < j) {
            System.out.println("Error: Min threshold must be bigger than max threshold");
        } else {
